export default function UrlPage() {
    return (
        <div className="w-4/5 mx-auto flex flex-col justify-center items-center mt-6">
            <h1 className='text-xl md:text-2xl text-center font-bold text-gray-700 tracking-wide leading-normal'>
                Fast and Easy URL Shortener!
                </h1>
            <p className='text-base tracking-wide leading-normal text-gray-700'>
                You can shorten long URL links with Shortly and share with your friends, 
